...
public class MDentityConfig {
    ...
    CommandLineRunner commandLineRaunner(precintRepository precinctRepository, countyRepository countyRepository, DistrictRepository districtRepository, DistrictingRepository districtingRepository, StateRepository stateRepository) throws IOException, ParseException {
        ...
        Object obj = new JSONParser().parse(new FileReader("src/main/java/com/example/demo/orgJson/MD_precincts_neighbors_with_incumbents.json"));
...
///////////////district////////////////
        Object obj2 = new JSONParser().parse(new FileReader("src/main/java/com/example/demo/orgJson/MD_cd.json"));
...
///////////////county////////////////
        Object obj3 = new JSONParser().parse(new FileReader("src/main/java/com/example/demo/orgJson/md_county.json"));
...
///////////////county////////////////
        ...
        return args -> {
            ...
            for (int i = 0; i < districtProperties.size(); i++) {
                ...
                String districtId = precinctINFO.get("DISTRICT").toString();

                districtId = ("MDX_" + districtId);
            ...
            for (int i = 0; i < precinctProperties.size(); i++) {
                ...
                newPrecinct.setTotalPopulation((Long) precinctINFO.get("ADJ_POP"));
                ...
                String districtID = (String) "MDX_" + precinctINFO.get("CD").toString();
            ...
            Object obj5 = new JSONParser().parse(new FileReader("src/main/java/com/example/demo/orgJson/md_state_bound.json"));
            ...
            State newState = new State("MARYLAND");
