...
///////////////county////////////////
        ...
        return args -> {
            ...
            {
                if ( Character.isAlphabetic(modifiedPrecincts.get(i).getPrecinctID().charAt(0))){
                    continue;
                }
            ...
            {
                if ( Character.isAlphabetic(result.get(i).getDistrictID().charAt(0))){
                    continue;
                }
            ...
            {
                if ( Character.isAlphabetic(dcounty.get(i).getCountyID().charAt(0))){
                    continue;
                }
