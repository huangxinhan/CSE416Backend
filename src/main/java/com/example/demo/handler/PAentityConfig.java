...
//            ArrayList<Precinct> modifiedPrecincts = (ArrayList<Precinct>) precinctRepository.findByprecinctIDStartsWith("42");
...
//
//            List<District> result = districtRepository.findBydistrictIDStartsWith("PA");
...
//            {
//                if (result3.get(i).getCountyID().startsWith("NY")){
//                    continue;
//                }
